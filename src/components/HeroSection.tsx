        ...
        <div className="animate-slide-up">
          ...
          <div className="flex justify-center mb-8">
            <div className="relative">
              <img src="/images/elitepay-logo.png" alt="ElitePay Official" className="w-20 h-20 object-contain relative z-10 rounded-2xl" />
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-extrabold mb-6 leading-[0.9] tracking-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Button
              ...
              className="bg-primary text-primary-foreground hover:bg-primary/90 shadow-glow text-lg px-10 py-7 rounded-2xl group font-display font-bold"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-border/60 text-foreground hover:bg-secondary/50 text-lg px-10 py-7 rounded-2xl font-display"
            >
              Explore Features
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 animate-slide-up" style={{ animationDelay: "0.3s" }}>
          {[
            ...
            <div key={i} className="glass-card-hover p-6 text-center">
              ...
              <h3 className="text-foreground font-display font-bold text-base">{item.label}</h3>
